...
Welcome to the Gigs (Frontend) project, a Nuxt 3 application designed to showcase a portfolio of my life's work across various technologies. Initially created as a personal tool to quickly find projects built with different technologies, it has evolved into a comprehensive display of my professional journey.

Linked to the [Gigs API](https://github.com/josephpickering9/work_gigs_api) project.

## Live Demo

Visit [gigs.josephpickering.co.uk](https://gigs.josephpickering.co.uk) to see the project in action.
...
- **Integration with Gigs (API):** This frontend is connected to a dedicated API service, providing dynamic data and interaction capabilities.
...
1. **Clone the repository:**
   ...
   ```bash
   git clone https://github.com/josephpickering9/work_gigs.git
   cd work_gigs
   ```
...
This project uses the openapi-typescript-codegen package to automatically generate TypeScript interfaces and types from the Swagger documentation provided by the Gigs (API) project. This process ensures type safety and accelerates development by providing auto-completion and validation based on the API's schema.
